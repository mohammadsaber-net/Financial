...
import { ArrowDownUp, ArrowUpDown, DotSquareIcon, Droplet, Edit, Loader2, LucideDropletOff, Menu, MenuSquareIcon, Plus, Trash } from 'lucide-react'
...
export default function AccountsPage() {
  ...
  return (
    ...
    <h2 className='text-xl md:texl-2xl mb-2 font-semibold'>Account Information</h2>
    <Button 
    ...
    variant={"default"} className='mb-6 transition active:!bg-gray-600 cursor-pointer'>
        ...
        <div className="pb-6 mb-2">
          ...
          placeholder="search using specific email..."/>
          <Button 
          className={`
